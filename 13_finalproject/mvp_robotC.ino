...
// ============================================================================
// ROBOT C — MAC 58:8C:81:9D:2A:D4 — chases Robot A
// Flash this sketch to Robot C only.
// ============================================================================
...
uint8_t TARGET_MAC[6] = {0x58, 0x8C, 0x81, 0xA0, 0x2F, 0x1C};   // → Robot A
...
void setup() {
  Serial.begin(115200);
  delay(500);
  Serial.println("=== ROBOT C starting (chases A) ===");
  motorsBegin();
