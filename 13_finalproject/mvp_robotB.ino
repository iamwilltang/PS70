...
// ============================================================================
// ROBOT B — MAC 58:8C:81:9F:BA:A8 — chases Robot C
// Flash this sketch to Robot B only.
// ============================================================================
...
uint8_t TARGET_MAC[6] = {0x58, 0x8C, 0x81, 0x9D, 0x2A, 0xD4};   // → Robot C
...
void setup() {
  Serial.begin(115200);
  delay(500);
  Serial.println("=== ROBOT B starting (chases C) ===");
  motorsBegin();
